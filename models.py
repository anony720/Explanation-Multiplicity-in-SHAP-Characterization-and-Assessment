...
class TabPFNWrapper(BaseEstimator, ClassifierMixin):
    ...
    def predict_proba(self, X):
        self._set_seed()
        # Do not fix seed at inference time to preserve SHAP sampling randomness.
...
def train_model(X_train, Y_train, MODEL, MODEL_SEED, num_features, cat_features):
    ...
    if param_grid:
        ...
        # Free memory by deleting the GridSearch object.
        del grid
        clean_memory()
    else:
        # For models without hyperparameter tuning (e.g., TabPFN).
