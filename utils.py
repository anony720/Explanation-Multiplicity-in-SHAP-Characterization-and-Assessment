...
def set_global_seed(seed: int):
    ...
    # Force deterministic ops for reproducibility (slight speed cost).
    torch.backends.cudnn.deterministic = True
    torch.backends.cudnn.benchmark = False

def clean_memory():
    """Releases CPU RAM and GPU VRAM."""
...
def load_data(dataset_name: str, data_dir: str = 'dataset'):
    """Loads X and Y pickle files from the dataset directory."""
    ...
    # Convert DataFrame to Series for easier indexing.
